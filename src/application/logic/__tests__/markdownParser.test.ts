...
`;
  ...
  it.skip('should parse an image with alt and title', () => {
...
describe('markdownToBlocks - Nested Blocks in Lists', () => {
  ...
  it('should parse a code block inside a list item', () => {
    ...
    // Attendu : ListItem, ListItem (le code block est ignoré dans extractInlineContent avec la version avancée)
    ...
    // Le CodeBlock imbriqué n'est pas extrait car extractInlineContent ignore les nœuds 'code'
  });
  ...
  it('should handle deeper nesting for code blocks', () => {
    ...
    // Attendu : ListItem (L1), ListItem (L2)
    expect(blocks).toHaveLength(2);
  });
